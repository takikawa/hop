...
(define (process-constants %this)
   (js-alist->jsobject
	...
	(COPYFILE_EXCL . ,(cond-expand (enable-libuv (UV_FS_COPYFILE_EXCL)) (else 0)))
	(COPYFILE_FICLONE . ,(cond-expand (enable-libuv (UV_FS_COPYFILE_FICLONE)) (else 0)))
	(COPYFILE_FICLONE_FORCE . ,(cond-expand (enable-libuv (UV_FS_COPYFILE_FICLONE_FORCE)) (else 0)))
